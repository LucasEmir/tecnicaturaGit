# Ejercici 11: Agenda telefónica
# Hacer un programa que simule una agenda de contactos. Crear un
# diccionario donde la clave sea el nombre del usuario y
# el valor sea el teléfono, el programa tendra el siguiente menu de opciones:
#       1. Nuevo contacto
#       2. Borrar contacto
